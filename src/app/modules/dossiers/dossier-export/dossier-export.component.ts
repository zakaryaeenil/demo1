...
@Component({
  ...
  styleUrls: ['./dossier-export.component.scss']
})
export class DossierExportComponent implements OnInit {
  ...
  getDossiersALl(){
    ...
    if(this.roles && this.roles.map(r => r.name == 'ADMIN')){
      this.service.getDossiersExport(this.helper).subscribe(
        data =>{
      ...
      this.service.getLoggedInEmployeeFolders(this.helper , 'export').subscribe(
        data =>{
          this.dossiers = data
          this.rowData$ = data;
        });
      ...
      this.service.getLoggedInClientFolders(this.helper , 'export').subscribe(
        data =>{
          this.dossiers = data
          this.rowData$ = data;
        });
  ...
  open(content : any) {
    ...
    this.modalService.open(content, { ariaLabelledBy: 'modal-basic-title' }).result.then((result) => {
      ...
      this.closeResult = `Dismissed ${DossierExportComponent.getDismissReason(reason)}`;
    });
  }
